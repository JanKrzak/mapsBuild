(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@agm/core'), require('@angular/common'), require('@angular/material')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@agm/core', '@angular/common', '@angular/material'], factory) :
    (factory((global.angularMaterialExtensionsGoogleMapsAutocomplete = {}),global.ng.core,global.ng.forms,global.agmCore,global.ng.common,global.ng.material));
}(this, (function (exports,core,forms,core$1,common,material) { 'use strict';
    ...
    var MatValidateAddressDirective = /** @class */ (function () {
        ...
        MatValidateAddressDirective.decorators = [
            { type: core.Directive, args: [{
                        selector: '[mat-addressInput-validate][formControlName],[MatValidateAddress][formControl],[MatValidateAddress][ngModel]',
                        providers: [
    ...
    var MatGoogleMapsAutocompleteComponent = /** @class */ (function () {
        function MatGoogleMapsAutocompleteComponent(_mapsAPILoader, _ngZone) {
            ...
            this.placeholderText = 'Please enter the addressInput';
            this.requiredErrorText = 'The addressInput is required';
            this.invalidErrorText = 'The addressInput is not valid';
    ...
    var MatGoogleMapsAutocompleteDirective = /** @class */ (function () {
        function MatGoogleMapsAutocompleteDirective(elemRef, mapsAPILoader, _ngZone) {
     ...
     * @suppress {checkTypes,extraRequire,missingReturn,uselessCode} checked by tsc
     */
    // export {MatValidateAddressDirective} from './directives/addressInput-validator/mat-addressInput-validator.directive';
